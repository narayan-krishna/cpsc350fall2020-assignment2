#ifndef MIRRORGAME_CPP
#define MIRRORGAME_CPP

#include "Game.h"

//a class dervied from the game class which creates a boundary around the
//original grid to mirror specifications
class MirrorGame:public Game{
  public:
    ...
    //updates the boundary to match the mirror specificationss
    ...
    //pause print method which incorporates the mirror grid boundary function
